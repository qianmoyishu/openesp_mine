...
#endif
#if CONFIG_APP_CLAW_CAP_XFYUN_SPEECH
...
#if CONFIG_APP_CLAW_CAP_OBS
static esp_err_t app_cap_prepare_obs(const app_claw_config_t *config,
                                     const app_claw_storage_paths_t *paths)
{
    (void)paths;
    return cap_obs_set_config(&(cap_obs_config_t) {
        .endpoint = config->obs_endpoint,
        .bucket = config->obs_bucket,
        .access_key = config->obs_access_key,
        .secret_key = config->obs_secret_key,
        .security_token = config->obs_security_token,
    });
}

static esp_err_t app_cap_register_obs(const app_claw_config_t *config,
                                      const app_claw_storage_paths_t *paths)
{
    (void)config;
    (void)paths;
    return cap_obs_register_group();
}
#endif

#if CONFIG_APP_CLAW_CAP_AT_MQTT
static esp_err_t app_cap_register_at_mqtt(const app_claw_config_t *config,
                                          const app_claw_storage_paths_t *paths)
{
    (void)config;
    (void)paths;
    return cap_at_mqtt_register_group();
}
#endif
...
#if CONFIG_APP_CLAW_CAP_XFYUN_SPEECH
static esp_err_t app_cap_prepare_xfyun_speech(const app_claw_config_t *config,
                                              const app_claw_storage_paths_t *paths)
{
    ESP_RETURN_ON_ERROR(cap_xfyun_speech_set_base_dir(paths->fatfs_base_path),
                        TAG, "Failed to set XFYun speech base dir");

    return cap_xfyun_speech_set_config(&(cap_xfyun_speech_config_t) {
...
static esp_err_t app_cap_register_xfyun_speech(const app_claw_config_t *config,
                                               const app_claw_storage_paths_t *paths)
{
    (void)config;
    (void)paths;
    return cap_xfyun_speech_register_group();
}
#endif
...
#endif
#if CONFIG_APP_CLAW_CAP_OBS
    { "cap_obs", "Huawei OBS", "Register Huawei OBS cap", true, app_cap_prepare_obs, app_cap_register_obs },
#endif
#if CONFIG_APP_CLAW_CAP_AT_MQTT
    { "cap_at_mqtt", "AT MQTT", "Register AT MQTT cap", true, NULL, app_cap_register_at_mqtt },
#endif
#if CONFIG_APP_CLAW_CAP_SKILL_MGR
...
#endif
#if CONFIG_APP_CLAW_CAP_XFYUN_SPEECH
    { "cap_xfyun_speech", "XFYun Speech", "Register XFYun speech cap", true, app_cap_prepare_xfyun_speech, app_cap_register_xfyun_speech },
#endif
#if CONFIG_APP_CLAW_CAP_ROUTER_MGR
...
#endif
#if CONFIG_APP_CLAW_CAP_OBS
    { "cap_obs", "Huawei OBS", true },
#endif
#if CONFIG_APP_CLAW_CAP_AT_MQTT
    { "cap_at_mqtt", "AT MQTT", true },
#endif
#if CONFIG_APP_CLAW_CAP_SKILL_MGR
...
#endif
#if CONFIG_APP_CLAW_CAP_XFYUN_SPEECH
    { "cap_xfyun_speech", "XFYun Speech", true },
#endif
#if CONFIG_APP_CLAW_CAP_ROUTER_MGR
