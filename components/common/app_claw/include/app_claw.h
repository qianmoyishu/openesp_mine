...
#define APP_CLAW_TOKEN_LEN            1024
...
typedef struct {
    ...
    char wifi_proxy_enabled[APP_CLAW_SHORT_STR_LEN];
    char wifi_proxy_address[APP_CLAW_STR_LEN];
    char wifi_proxy_port[APP_CLAW_TIMEOUT_LEN];
    ...
    char obs_endpoint[APP_CLAW_STR_LEN];
    char obs_bucket[APP_CLAW_STR_LEN];
    char obs_access_key[APP_CLAW_STR_LEN];
    char obs_secret_key[APP_CLAW_STR_LEN];
    char obs_security_token[APP_CLAW_TOKEN_LEN];
    char xfyun_app_id[APP_CLAW_STR_LEN];
    char xfyun_api_key[APP_CLAW_STR_LEN];
    char xfyun_api_secret[APP_CLAW_STR_LEN];
