...
export const GROUP_FIELDS: Record<ConfigGroup, (keyof AppConfig)[]> = {
  wifi: ['wifi_ssid', 'wifi_password', 'wifi_proxy_enabled', 'wifi_proxy_address', 'wifi_proxy_port'],
  llm: [
    'llm_api_key',
    'llm_backend_type',
    'llm_profile',
  ...
  obs: ['obs_endpoint', 'obs_bucket', 'obs_access_key', 'obs_secret_key', 'obs_security_token'],
  speech: ['xfyun_app_id', 'xfyun_api_key', 'xfyun_api_secret'],
