...
type ProviderKey = 'openai' | 'bailian' | 'deepseek' | 'gemini' | 'anthropic' | 'compatible';
              ...
              <Switch>
                <Match when={step() === 0}>
                  <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    >
                      ...
                      <option value="gemini">{t('setupLlmProviderGemini') as string}</option>
                ...
                <Match when={step() === 1}>
                  <div class="flex flex-col gap-5">
                    {/* Platform picker is always visible */}
