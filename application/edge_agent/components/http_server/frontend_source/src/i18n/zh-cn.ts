...
export const zhCn: Dict = {
  ...
  sectionWifiAdvanced: 'Wi-Fi 更多选项',
  wifiProxyAddress: '代理地址',
  wifiProxyPort: '代理端口',
  wifiProxyEnabled: 'LLM 请求使用代理',
  passwordShow: '显示密码',
  passwordHide: '隐藏密码',
  wifiValidationSsidRequired: 'Wi-Fi 名称不能为空。',
  wifiValidationPasswordLength: 'Wi-Fi 密码要么留空，要么至少 8 个字符。',
  wifiValidationProxyRequired: '代理地址和端口需要一起配置。',
  wifiValidationProxyPort: '代理端口必须是 1 到 65535 之间的整数。',

  sectionObs: '华为云 OBS 设置',
  ...
  obsSecurityTokenHint: '可选。仅使用临时凭证时需要填写。',
  obsValidationEndpointBucket: '填写 OBS 凭据时，Endpoint 和 Bucket 不能为空。',
  obsValidationAkSk: 'OBS AK 和 SK 需要一起配置。',

  sectionXfyunSpeech: '讯飞语音设置',
  xfyunAppId: '讯飞 APP ID',
  xfyunApiKey: '讯飞 API Key',
  xfyunApiSecret: '讯飞 API Secret',
  xfyunSpeechHint: '供讯飞 ASR 和 TTS capability 使用。',
  xfyunValidationComplete: '讯飞 APP ID、API Key、API Secret 需要一起配置。',
  ...
  fileDevModeConfirm:
    '进入开发者模式后，你可以上传、修改或删除文件。不正确的增删改可能导致系统无法正常运行、无限重启等问题。请谨慎修改。',
  ...
  setupLlmProviderCompatible: '兼容 API',
  setupLlmCompatibleMode: '兼容模式',
  setupLlmCompatibleOpenai: 'OpenAI 兼容',
  setupLlmCompatibleClaude: 'Claude 兼容',
  setupImAdd: '添加',
