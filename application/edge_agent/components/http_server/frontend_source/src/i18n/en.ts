export const en = {
  ...
  sectionWifiAdvanced: 'Wi-Fi More Options',
  wifiProxyAddress: 'Proxy Address',
  wifiProxyPort: 'Proxy Port',
  wifiProxyEnabled: 'Use proxy for LLM requests',
  ...
  wifiValidationProxyRequired: 'Proxy address and port must be configured together.',
  wifiValidationProxyPort: 'Proxy port must be an integer between 1 and 65535.',

  sectionObs: 'Huawei OBS Settings',
  obsEndpoint: 'OBS Endpoint',
  obsBucket: 'OBS Bucket',
  obsAccessKey: 'Access Key (AK)',
  obsSecretKey: 'Secret Key (SK)',
  obsSecurityToken: 'Security Token',
  obsSecurityTokenHint: 'Optional. Only required when using temporary credentials.',
  obsValidationEndpointBucket: 'OBS endpoint and bucket are required when OBS credentials are set.',
  obsValidationAkSk: 'OBS AK and SK must be configured together.',

  sectionXfyunSpeech: 'XFYun Speech Settings',
  xfyunAppId: 'XFYun APP ID',
  xfyunApiKey: 'XFYun API Key',
  xfyunApiSecret: 'XFYun API Secret',
  xfyunSpeechHint: 'Used by the XFYun ASR and TTS capability.',
  xfyunValidationComplete: 'XFYun APP ID, API Key, and API Secret must be configured together.',
  ...
  llmProfilePlaceholder:
    'openai / qwen_compatible / gemini / custom_openai_compatible / anthropic',
  llmBaseUrl: 'Base URL',
  ...
  setupLlmProviderBailian: 'Alibaba Bailian',
  setupLlmProviderGemini: 'Google Gemini',
  setupLlmProviderClaude: 'Anthropic Claude',
  setupLlmProviderCompatible: 'Compatible API',
  setupLlmCompatibleMode: 'Compatibility Mode',
  setupLlmCompatibleOpenai: 'OpenAI Compatible',
  setupLlmCompatibleClaude: 'Claude Compatible',
  setupImAdd: 'Add',
