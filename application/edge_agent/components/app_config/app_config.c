...
#define APP_DEFAULT_WIFI_PROXY_ENABLED    "0"
#define APP_DEFAULT_WIFI_PROXY_ADDRESS    ""
#define APP_DEFAULT_WIFI_PROXY_PORT       ""
...
#define APP_DEFAULT_OBS_ENDPOINT          "obs.cn-north-4.myhuaweicloud.com"
#define APP_DEFAULT_OBS_BUCKET            ""
#define APP_DEFAULT_OBS_ACCESS_KEY        ""
#define APP_DEFAULT_OBS_SECRET_KEY        ""
#define APP_DEFAULT_OBS_SECURITY_TOKEN    ""
#define APP_DEFAULT_XFYUN_APP_ID          ""
#define APP_DEFAULT_XFYUN_API_KEY         ""
#define APP_DEFAULT_XFYUN_API_SECRET      ""
...
static const app_config_field_t s_fields[] = {
    ...
    APP_CONFIG_FIELD(wifi_proxy_enabled, "wifi_proxy_en", APP_DEFAULT_WIFI_PROXY_ENABLED),
    APP_CONFIG_FIELD(wifi_proxy_address, "wifi_proxy_addr", APP_DEFAULT_WIFI_PROXY_ADDRESS),
    APP_CONFIG_FIELD(wifi_proxy_port, "wifi_proxy_port", APP_DEFAULT_WIFI_PROXY_PORT),
    ...
    APP_CONFIG_FIELD(obs_endpoint, "obs_endpoint", APP_DEFAULT_OBS_ENDPOINT),
    APP_CONFIG_FIELD(obs_bucket, "obs_bucket", APP_DEFAULT_OBS_BUCKET),
    APP_CONFIG_FIELD(obs_access_key, "obs_ak", APP_DEFAULT_OBS_ACCESS_KEY),
    APP_CONFIG_FIELD(obs_secret_key, "obs_sk", APP_DEFAULT_OBS_SECRET_KEY),
    APP_CONFIG_FIELD(obs_security_token, "obs_token", APP_DEFAULT_OBS_SECURITY_TOKEN),
    APP_CONFIG_FIELD(xfyun_app_id, "xfyun_app_id", APP_DEFAULT_XFYUN_APP_ID),
    APP_CONFIG_FIELD(xfyun_api_key, "xfyun_api_key", APP_DEFAULT_XFYUN_API_KEY),
    APP_CONFIG_FIELD(xfyun_api_secret, "xfyun_secret", APP_DEFAULT_XFYUN_API_SECRET),
...
void app_config_to_claw(const app_config_t *config, app_claw_config_t *out)
{
    ...
    strlcpy(out->wifi_proxy_enabled, config->wifi_proxy_enabled, sizeof(out->wifi_proxy_enabled));
    strlcpy(out->wifi_proxy_address, config->wifi_proxy_address, sizeof(out->wifi_proxy_address));
    strlcpy(out->wifi_proxy_port, config->wifi_proxy_port, sizeof(out->wifi_proxy_port));
    ...
    strlcpy(out->obs_endpoint, config->obs_endpoint, sizeof(out->obs_endpoint));
    strlcpy(out->obs_bucket, config->obs_bucket, sizeof(out->obs_bucket));
    strlcpy(out->obs_access_key, config->obs_access_key, sizeof(out->obs_access_key));
    strlcpy(out->obs_secret_key, config->obs_secret_key, sizeof(out->obs_secret_key));
    strlcpy(out->obs_security_token, config->obs_security_token, sizeof(out->obs_security_token));
    strlcpy(out->xfyun_app_id, config->xfyun_app_id, sizeof(out->xfyun_app_id));
    strlcpy(out->xfyun_api_key, config->xfyun_api_key, sizeof(out->xfyun_api_key));
    strlcpy(out->xfyun_api_secret, config->xfyun_api_secret, sizeof(out->xfyun_api_secret));
