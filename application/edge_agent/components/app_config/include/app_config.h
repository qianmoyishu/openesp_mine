...
#define APP_CONFIG_TOKEN_LEN      1024
...
typedef struct {
    ...
    char wifi_proxy_enabled[8];
    char wifi_proxy_address[APP_CONFIG_STR_LEN];
    char wifi_proxy_port[16];
    ...
    char obs_endpoint[APP_CONFIG_STR_LEN];
    char obs_bucket[APP_CONFIG_STR_LEN];
    char obs_access_key[APP_CONFIG_STR_LEN];
    char obs_secret_key[APP_CONFIG_STR_LEN];
    char obs_security_token[APP_CONFIG_TOKEN_LEN];
    char xfyun_app_id[APP_CONFIG_STR_LEN];
    char xfyun_api_key[APP_CONFIG_STR_LEN];
    char xfyun_api_secret[APP_CONFIG_STR_LEN];
